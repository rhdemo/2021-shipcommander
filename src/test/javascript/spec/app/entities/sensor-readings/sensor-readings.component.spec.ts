...
import { SensorReadingsComponent } from 'app/entities/sensor-readings/sensor-readings.component';
...
describe('Component Tests', () => {
  describe('SensorReadings Management Component', () => {
    let comp: SensorReadingsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SensorReadingsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.sensorReadings && comp.sensorReadings[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
