...
import com.redhat.domain.User;
import com.redhat.service.InvalidPasswordException;
import com.redhat.service.MailService;
import com.redhat.service.UserService;
import com.redhat.service.UsernameAlreadyUsedException;
import com.redhat.service.dto.PasswordChangeDTO;
import com.redhat.service.dto.UserDTO;
import com.redhat.web.rest.errors.EmailAlreadyUsedException;
import com.redhat.web.rest.errors.EmailNotFoundException;
import com.redhat.web.rest.errors.LoginAlreadyUsedException;
import com.redhat.web.rest.vm.KeyAndPasswordVM;
import com.redhat.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
    ...
    public CompletionStage<Response> registerAccount(@Valid ManagedUserVM managedUserVM) {
        ...
        } catch (com.redhat.service.EmailAlreadyUsedException e) {
            throw new EmailAlreadyUsedException();
        }
    }
