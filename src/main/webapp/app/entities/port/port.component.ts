...
export class PortComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.portService
      ...
      .subscribe(
        (res: HttpResponse<IPort[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInPorts(): void {
    this.eventSubscriber = this.eventManager.subscribe('portListModification', () => this.loadPage());
  }
