...
export class ContainerComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.containerService
      ...
      .subscribe(
        (res: HttpResponse<IContainer[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInContainers(): void {
    this.eventSubscriber = this.eventManager.subscribe('containerListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IContainer[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
